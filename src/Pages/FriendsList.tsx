        ...
        <main className='friendsList__main'>
            <div className="friendsList__container">
                <div className="friendsList__header">
                    ...
                    <button className="friendsList__header-searchFriends">Найти друзей</button>
                </div>
            ...
            {friends.map(friend => <FriendCard key={friend.id} friend={friend} onFriendDelete={onFriendDelete}/>)}
        </main>
    );
};
